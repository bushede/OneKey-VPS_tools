...
bash <(curl -Ls https://raw.githubusercontent.com/用户名/仓库名/main/vmess-ws-universal.sh)
bash <(curl -Ls https://raw.githubusercontent.com/用户名/仓库名/main/cloudreve-nginx-universal.sh)
